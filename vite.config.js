  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // File handler so a tapped .csv can launch the app on platforms that support it.
        // iOS Safari does not yet honor this, but Android Chrome and desktop browsers do.
        file_handlers: [
          {
            action: '/',
            accept: { 'text/csv': ['.csv'] },
